...
class TriangleTestCase(unittest.TestCase):
    ...
    def test_zero_side_perimeter(self):
        ...
        Параметры на вход:
        a = 0 (float) - первая нулевая сторона треугольника
        b = 0 (float) - вторая нулевая сторона треугольника
        c = 0 (float) - третья нулевая сторона треугольника

        Ожидаемый результат:
        perimeter = 0 (float) - периметр треугольника должен быть равен 0
        '''
